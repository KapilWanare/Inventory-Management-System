...
import com.inventorymanagementsystem.entity.Employee;
...
public class LoginController implements Initializable {
    ...
    public void dropShowAffect(){
        ...
        I_logo.setEffect(original);
        M_logo.setEffect(original);
    }
    ...
    public void supplier(){
   	 connection= Database.getInstance().connectDB();
       String sql="SELECT * FROM supplier WHERE username=? and password=?";
       try{
           ...
           resultSet=preparedStatement.executeQuery();
           if(resultSet.next()){
               s.name=username.getText();
               Alert alert=new Alert(Alert.AlertType.INFORMATION);
               alert.setTitle("Success Message");
               alert.setHeaderText(null);
               alert.setContentText("Login Successful !");
               alert.showAndWait();
               supplier_btn.getScene().getWindow().hide();
               Parent root = FXMLLoader.load(getClass().getResource("bills.fxml"));
               Scene scene = new Scene(root);
               Stage stage=new Stage();
